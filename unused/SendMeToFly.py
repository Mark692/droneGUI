...
(sendMeToFly_tab_class, connect_widget_base_class) = (
    uic.loadUiType(
        cfclient.module_path + "/ui/tabs/sendMeToFly.ui")
    )
...
class AnchorPositionDialog(QtWidgets.QWidget, sendMeToFly_tab_class):
